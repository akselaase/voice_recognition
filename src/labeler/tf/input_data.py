...
class AudioProcessor(object):
    ...
    def __init__(self, data_url, data_dir, silence_percentage, unknown_percentage,
        ...
        self.prepare_data_index(silence_percentage, unknown_percentage,
                                ...
                                testing_percentage, max_samples_per_word)
    ...
    def prepare_data_index(self, silence_percentage, unknown_percentage,
        ...
        Args:
          ...
          validation_percentage: How much of the data set to use for validation.
          testing_percentage: How much of the data set to use for testing.
          max_samples_per_word: How many samples to use for each word from the data set.
        ...
        for wav_path in gfile.Glob(search_path):
            ...
            # Move the word to the 'testing' dataset if we've hit our limit in the
            # 'training' dataset.
            if max_samples_per_word > 0 and word_count[word] >= max_samples_per_word:
                set_index = 'testing'
            word_count[word] += 1
        ...
        for index, wanted_word in enumerate(wanted_words):
            if wanted_word not in word_count:
                raise Exception('Expected to find ' + wanted_word +
                                ' in labels but only found ' +
                                ', '.join(word_count.keys()))
